...
import { BarChart3, Home, PlusCircle, TrendingDown, TrendingUp, Trash2, Users, Package } from "lucide-react"
    ...
    <div className="flex min-h-screen flex-col">
        ...
        <div className="container flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-6">
            ...
            <nav className="hidden md:flex gap-6">
              ...
              <Link href="/stocks" className="flex items-center gap-2 text-sm font-medium text-white">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 border-t bg-white">
        <div className="grid grid-cols-5 gap-1 p-2">
          ...
          <Link href="/stocks" className="flex flex-col items-center justify-center py-2 text-blue-600">
