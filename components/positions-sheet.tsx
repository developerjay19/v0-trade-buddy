...
export function PositionsSheet() {
  const { stocks, user, editHolding, closePosition, cancelOrder, createOrder } = useTrading()
    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        ...
        >
          ...
          Positions & Orders ({openHoldings.length + activeOrders.length})
        </Button>
      </SheetTrigger>
      <SheetContent side="bottom" className="h-[80vh] overflow-y-auto">
        <SheetHeader>
          ...
          <SheetDescription>Manage your active positions and pending orders</SheetDescription>
        </SheetHeader>
            ...
            <TabsContent value="positions" className="space-y-4 mt-4">
              {openHoldings.length > 0 ? (
                openHoldings.map((holding) => {
                  ...
                  const positionType = holding.positionType
                  ...
                  return (
                    <Card
                      key={holding.id}
                      className={`border ${
                        positionType === "long" ? "border-green-200 bg-green-50" : "border-red-200 bg-red-50"
                      }`}
                    >
                      <CardContent className="p-4">
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              <Badge
                                ...
                                className={
                                  positionType === "long" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                                }
                              >
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    Are you sure you want to close your {positionType.toLowerCase()} position in{" "}
                                    {stock.name}? This will {positionType === "long" ? "sell" : "buy"}{" "}
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4">You don't have any active trading positions.</p>
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <div className="font-semibold text-gray-900">
                              {order.price ? `₹${order.price.toFixed(2)}` : "Market Price"}
                            </div>
                          </div>
                        </div>
